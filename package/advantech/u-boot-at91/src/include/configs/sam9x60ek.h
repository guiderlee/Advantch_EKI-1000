...
#define CONFIG_EXTRA_ENV_SETTINGS \
				"mtdparts=spi0:256k(bootstrap),768k(u-boot),64k(env),64k(env_redundant),24m(firmware),6m(rootfs_data),-(reserved)\0" \
                                "ethaddr=00:d0:c9:00:00:01\0" \
                                "wlanaddr=00:d0:c9:00:00:02\0" \
                                "image_addr=0x3620000\0" \
                                "bootargs_=console=ttyAT2,115200 rootfstype=squashfs\0" \
				"spiboot=setenv bootargs ${bootargs_} mtdparts=${mtdparts};sf probe 0; sf read 0x22000000 0x120000 0x500000; bootm 0x22000000\0" 
#endif
