...
Package/mwifiex-usb-firmware = $(call Package/firmware-default,Marvell 8887/8997 firmware)
define Package/mwifiex-usb-firmware/install
	$(INSTALL_DIR) $(1)/lib/firmware/mrvl
	$(INSTALL_DATA) \
		$(PKG_BUILD_DIR)/mrvl/usbusb8997_combo_v4.bin \
		$(1)/lib/firmware/mrvl/
	ln -s ../mrvl/usbusb8997_combo_v4.bin $(1)/lib/firmware/mrvl/usb8997_uapsta.bin
endef
